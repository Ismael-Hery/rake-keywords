...
function addCandidatesAndComponents(block, result) {
  ...
  if (trimmed !== '') {
    if (result.candidates[trimmed.toLowerCase()] === undefined) {
      result.candidates[trimmed.toLowerCase()] = {};
      result.candidates[trimmed.toLowerCase()].occurrences = [trimmed];
      result.candidates[trimmed.toLowerCase()].subcomponents = block.asArray;
    } else {
      result.candidates[trimmed.toLowerCase()].occurrences.push(trimmed);
    }
